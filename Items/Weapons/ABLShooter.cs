...
{
    public class ABLShooter : ModItem          
	{
		int mode = 0;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Insane Cannon Lance");
			Tooltip.SetDefault("40% to not consume ammo"
		...
		public override void SetDefaults()    
		{
			...
			item.maxStack = 1;                 
			item.autoReuse = true;  
			item.shoot = mod.ProjectileType("ARShoot");                     
			item.shootSpeed = 65f; 
			item.UseSound = SoundID.Item11;
				}
				else if (mode == 2)
			...
			item.autoReuse = true; 
			item.useAmmo = 0;
			item.shoot = mod.ProjectileType("ARLaser");                     
			item.shootSpeed = 65f; 
			item.UseSound = SoundID.Item11;
				}  
