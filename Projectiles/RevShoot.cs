...
{
    public class RevShoot : ModProjectile
    {
    ...
    //this is the projectile name
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            if (_charge == 0)
            {
                ...
                unit.Normalize();
                DrawLaser(spriteBatch, Main.projectileTexture[projectile.type], pos, unit, 5, projectile.damage, -1.57f, 1f, 1000f, Color.White, 72);// this is the projectile sprite draw, 45 = the distance of where the projectile starts from the player
            }
            return false;
        ...
        public override void AI()
        {
			...
			else
            {
                ...
                for (int k = 0; k < chargeFact + 1; k++)
                {
                    ...
                    Dust dust = Main.dust[Dust.NewDust(dustPos, 30, 30, 107, projectile.velocity.X / 2f,    //this 30, 30 is the dust weight and height 235 is the tail dust    
            ...
            for (int i = 0; i < 2; ++i)
            {
                ...
                Dust dust = Main.dust[Dust.NewDust(_targetPos, 0, 0, 107, dustVel.X, dustVel.Y, 0, new Color(), 1f)];  //this is the head dust
                Dust dust2 = Main.dust[Dust.NewDust(_targetPos, 0, 0, 107, dustVel.X, dustVel.Y, 0, new Color(), 1f)]; //this is the head dust 2
                dust.noGravity = true;
                dust.scale = 1.2f;
            }
