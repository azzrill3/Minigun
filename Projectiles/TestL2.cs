...
{
    public class TestL2 : ModProjectile
    {
    ...
    //this is the projectile name
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            if (_charge == 5)
            {
                ...
                unit.Normalize();
                DrawLaser(spriteBatch, Main.projectileTexture[projectile.type], pos, unit, 5, projectile.damage, -1.57f, 1f, 1000f, Color.White, 120);// this is the projectile sprite draw, 45 = the distance of where the projectile starts from the player
            }
            return false;
